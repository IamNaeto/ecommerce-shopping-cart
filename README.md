...
- An e-commerce web page with fully functional shopping cart making it possible for a user to be able to add a product to the cart, remove a product from the cart and place an order.
